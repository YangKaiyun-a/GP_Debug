#include "amplification_dj1.h"
#include "amplification_dj1.h"
#include "Driver/commander.h"


Amplification_Dj1::Amplification_Dj1()
{

}

Amplification_Dj1 *Amplification_Dj1::instance()
{
    static Amplification_Dj1 amplification_dj1_ins;

    return &amplification_dj1_ins;
}

quint16 Amplification_Dj1::select_motor_reset_index(int motor_id)
{
    quint16 index;
    switch (motor_id) {
    case 0:
...
quint16 Amplification_Dj1::select_motor_move_index(int motor_id)
{
    quint16 index;
    switch (motor_id) {
    case 0:
...
//0：X轴，1：Y轴，2：夹爪复位，3：夹爪Z轴复位，4：DJ1Z轴复位，5：柱塞泵复位
int Amplification_Dj1::motorReset(int motorIndex)
{
    int result = -1;
    ...
    Commander c(DevicePart::NODE_AMPLIFICATION_DJ1);
    ...
    else if(motorIndex == MOTOR_DJ1_Z)
    {
        controlItem.index.index = index;
        controlItem.index.sub_index = 0x01;
        controlItem.data = ACTION_CONTROL;
    ...
    else if(motorIndex == MOTOR_PIPET)
    {
        controlItem.index.index = index;
        controlItem.index.sub_index = 0x04;
        controlItem.data = ACTION_CONTROL;
...
int Amplification_Dj1::motorMove(int motorIndex, const DevicePart::MotorMotionParams &param)
{
    int result = -1;
...
int Amplification_Dj1::module_reset()
{
    int result = -1;
...
int Amplification_Dj1::aspirate(const Amplification_Dj1::AspiraterParams &param)
{
    int result = -1;
...
int Amplification_Dj1::squirt(const Amplification_Dj1::SquirtParams &param)
{
    int result = -1;
...
int Amplification_Dj1::liquidMix(const Amplification_Dj1::LiquidMixParams &param)
{
    int result = -1;
...
int Amplification_Dj1::pause()
{

}

int Amplification_Dj1::resume()
{

}

int Amplification_Dj1::move(Amplification_Dj1::RackMotionParams param)
{
    int result = -1;
...
int Amplification_Dj1::init_clean_start(float z_position)
{
    int result = -1;
    ...
    int z_pos = DOUBLE_FROM_OD_DATA(z_position);
    QVector<Commander::SDOitem> items;
    items << Commander::SDOitem(index, 0x03, &z_pos);
...
int Amplification_Dj1::remainder_check_clean_start(float z_position)
{
    int result = -1;
...
int Amplification_Dj1::routine_clean_strart(int time, float z_position)
{
    int result = -1;
    ...
    items << Commander::SDOitem(index, 0x03, &time)\
          << Commander::SDOitem(index, 0x04, &z_pos) ;
    Commander c(DevicePart::NODE_AMPLIFICATION_DJ1);
...
int Amplification_Dj1::cleaning_liqud_clean_start(int cleaning_liquid_clean_time, int pure_water_clean_time, float z_position)
{
    int result = -1;
    ...
    items << Commander::SDOitem(index, 0x03, &cleaning_liquid_clean_time) \
          ...
          << Commander::SDOitem(index, 0x05, &z_pos) ;
...
int Amplification_Dj1::open_inside_valve()
{
    int result = -1;
...
int Amplification_Dj1::close_inside_valve()
{
    int result = -1;
...
int Amplification_Dj1::open_outside_valve()
{
    int result = -1;
...
int Amplification_Dj1::close_outside_valve()
{
    int result = -1;
...
int Amplification_Dj1::open_inside_pump()
{
    int result = -1;
...
int Amplification_Dj1::close_inside_pump()
{
    int result = -1;
...
int Amplification_Dj1::open_outside_pump()
{
    int result = -1;
...
int Amplification_Dj1::close_outside_pump()
{
    int result = -1;
...
int Amplification_Dj1::open_waste_pump()
{
    int result = -1;
...
int Amplification_Dj1::close_waste_pump()
{
    int result = -1;
...
int Amplification_Dj1::open_clean_pump()
{
    int result = -1;
...
int Amplification_Dj1::close_clean_pump()
{
    int result = -1;
...
int Amplification_Dj1::open_clean_valve()
{
    int result = -1;
...
int Amplification_Dj1::close_clean_valve()
{
    int result = -1;
...
int Amplification_Dj1::glab(float glabWidth)
{
    int result = -1;
...
int Amplification_Dj1::release(float releaseWidth)
{
    int result = -1;
...
int Amplification_Dj1::toZGlab(float zPosition, float openWidth, float closeWidth, float finish_z_position)
{
    int result = -1;
    ...
    int widthClose = DOUBLE_FROM_OD_DATA(closeWidth);
    int finish_positin = DOUBLE_FROM_OD_DATA(finish_z_position);

    items << Commander::SDOitem(index, 0x03, &zPos) \
          << Commander::SDOitem(index, 0x04, &widthOpen) \
          << Commander::SDOitem(index, 0x05, &widthClose) \
          << Commander::SDOitem(index, 0x06, &finish_positin);
...
int Amplification_Dj1::toZRelease(float zPosition, float releaseWidth)
{
    int result = -1;
...
int Amplification_Dj1::relative_aspirate(float aspirate_speed, int acc_num, float aspirate_volume)
{
    int result = -1;
...
int Amplification_Dj1::getParameter(Amplification_Dj1::AmplificationDj1Params &params)
{
    int result = -1;
...
int Amplification_Dj1::setParameter(const Amplification_Dj1::AmplificationDj1Params &params)
{
    int result = -1;
    quint16 index = DJ1_INDEX(PARAMETER);
